<!DOCTYPE html>
    <!-- 
        This php file is to handle a RESULT of the top 10 most rated Movies.
    ...
    <?php 
        ...
        if(Mysqli_num_rows($result) != 0){
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                //Draw the bar
                $x1 = $itemX - $barWidth / 2;
                $y1 = $gridBottom - (int)$row['likes'] / $yMaxValue * $gridHeight;
                $x2 = $itemX + $barWidth / 2;
                $y2 = $gridBottom;
                ...
                //Draw the value
                imagettftext($image, $fontSize, 0, ($x1+$barWidth / 4), ($y1 - 5), $labelColour, $font, $row['likes']);
            ...
            //Post to browser
            imagepng($image, "Ratings.png");
            imagedestroy($image);
            echo "<img src='Ratings.png' alt='Top 10 Rated Movies'><p></p>";
        }
        else {
